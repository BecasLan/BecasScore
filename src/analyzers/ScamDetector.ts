...
export class ScamDetector {
  ...
  constructor() {
    // 🔥 USE QWEN3:8B for scam detection - superior context understanding
    this.ollama = new OllamaService('analysis'); // analysis config now uses Qwen3:8b
    console.log('🔍 ScamDetector: Using Qwen3:8b for superior context analysis');
  }
